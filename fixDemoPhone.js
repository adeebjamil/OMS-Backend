// Quick script to fix Demo intern phone number format
...
const connectDB = async () => {
  try {
    ...
    // Find Demo intern and update phone to correct format
    ...
    if (demo) {
      ...
      console.log('✅ Demo intern can now use forgot password!');
    } else {
